...
phenotype *mate_individuals(phenotype *phenotype_1, phenotype *phenotype_2, const options *opt) {
    phenotype *offspring =
            f_rand() < opt->crossover_rate ?
            initialize_phenotype(crossover_genotypes(phenotype_1->gen, phenotype_2->gen, opt))
                                           : copy_phenotype(b_rand() ? phenotype_1 : phenotype_2, opt);
